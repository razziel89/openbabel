...
class StdMapStringString(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    ...
    def __init__(self, *args): 
        _openbabel.StdMapStringString_swiginit(self,_openbabel.new_StdMapStringString(*args))
    __swig_destroy__ = _openbabel.delete_StdMapStringString
StdMapStringString.iterator = new_instancemethod(_openbabel.StdMapStringString_iterator,None,StdMapStringString)
StdMapStringString.__nonzero__ = new_instancemethod(_openbabel.StdMapStringString___nonzero__,None,StdMapStringString)
StdMapStringString.__bool__ = new_instancemethod(_openbabel.StdMapStringString___bool__,None,StdMapStringString)
StdMapStringString.__len__ = new_instancemethod(_openbabel.StdMapStringString___len__,None,StdMapStringString)
StdMapStringString.__getitem__ = new_instancemethod(_openbabel.StdMapStringString___getitem__,None,StdMapStringString)
StdMapStringString.__delitem__ = new_instancemethod(_openbabel.StdMapStringString___delitem__,None,StdMapStringString)
StdMapStringString.has_key = new_instancemethod(_openbabel.StdMapStringString_has_key,None,StdMapStringString)
StdMapStringString.keys = new_instancemethod(_openbabel.StdMapStringString_keys,None,StdMapStringString)
StdMapStringString.values = new_instancemethod(_openbabel.StdMapStringString_values,None,StdMapStringString)
StdMapStringString.items = new_instancemethod(_openbabel.StdMapStringString_items,None,StdMapStringString)
StdMapStringString.__contains__ = new_instancemethod(_openbabel.StdMapStringString___contains__,None,StdMapStringString)
StdMapStringString.key_iterator = new_instancemethod(_openbabel.StdMapStringString_key_iterator,None,StdMapStringString)
StdMapStringString.value_iterator = new_instancemethod(_openbabel.StdMapStringString_value_iterator,None,StdMapStringString)
StdMapStringString.__setitem__ = new_instancemethod(_openbabel.StdMapStringString___setitem__,None,StdMapStringString)
StdMapStringString.asdict = new_instancemethod(_openbabel.StdMapStringString_asdict,None,StdMapStringString)
StdMapStringString.empty = new_instancemethod(_openbabel.StdMapStringString_empty,None,StdMapStringString)
StdMapStringString.size = new_instancemethod(_openbabel.StdMapStringString_size,None,StdMapStringString)
StdMapStringString.clear = new_instancemethod(_openbabel.StdMapStringString_clear,None,StdMapStringString)
StdMapStringString.swap = new_instancemethod(_openbabel.StdMapStringString_swap,None,StdMapStringString)
StdMapStringString.get_allocator = new_instancemethod(_openbabel.StdMapStringString_get_allocator,None,StdMapStringString)
StdMapStringString.begin = new_instancemethod(_openbabel.StdMapStringString_begin,None,StdMapStringString)
StdMapStringString.end = new_instancemethod(_openbabel.StdMapStringString_end,None,StdMapStringString)
StdMapStringString.rbegin = new_instancemethod(_openbabel.StdMapStringString_rbegin,None,StdMapStringString)
StdMapStringString.rend = new_instancemethod(_openbabel.StdMapStringString_rend,None,StdMapStringString)
StdMapStringString.count = new_instancemethod(_openbabel.StdMapStringString_count,None,StdMapStringString)
StdMapStringString.erase = new_instancemethod(_openbabel.StdMapStringString_erase,None,StdMapStringString)
StdMapStringString.find = new_instancemethod(_openbabel.StdMapStringString_find,None,StdMapStringString)
StdMapStringString.lower_bound = new_instancemethod(_openbabel.StdMapStringString_lower_bound,None,StdMapStringString)
StdMapStringString.upper_bound = new_instancemethod(_openbabel.StdMapStringString_upper_bound,None,StdMapStringString)
StdMapStringString_swigregister = _openbabel.StdMapStringString_swigregister
...
class vectorOBAtom(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __iter__(self): return self.iterator()
    def __init__(self, *args): 
        _openbabel.vectorOBAtom_swiginit(self,_openbabel.new_vectorOBAtom(*args))
    __swig_destroy__ = _openbabel.delete_vectorOBAtom
vectorOBAtom.iterator = new_instancemethod(_openbabel.vectorOBAtom_iterator,None,vectorOBAtom)
vectorOBAtom.__nonzero__ = new_instancemethod(_openbabel.vectorOBAtom___nonzero__,None,vectorOBAtom)
vectorOBAtom.__bool__ = new_instancemethod(_openbabel.vectorOBAtom___bool__,None,vectorOBAtom)
vectorOBAtom.__len__ = new_instancemethod(_openbabel.vectorOBAtom___len__,None,vectorOBAtom)
vectorOBAtom.__getslice__ = new_instancemethod(_openbabel.vectorOBAtom___getslice__,None,vectorOBAtom)
vectorOBAtom.__setslice__ = new_instancemethod(_openbabel.vectorOBAtom___setslice__,None,vectorOBAtom)
vectorOBAtom.__delslice__ = new_instancemethod(_openbabel.vectorOBAtom___delslice__,None,vectorOBAtom)
vectorOBAtom.__delitem__ = new_instancemethod(_openbabel.vectorOBAtom___delitem__,None,vectorOBAtom)
vectorOBAtom.__getitem__ = new_instancemethod(_openbabel.vectorOBAtom___getitem__,None,vectorOBAtom)
vectorOBAtom.__setitem__ = new_instancemethod(_openbabel.vectorOBAtom___setitem__,None,vectorOBAtom)
vectorOBAtom_swigregister = _openbabel.vectorOBAtom_swigregister
vectorOBAtom_swigregister(vectorOBAtom)
...
OBMol.Assign = new_instancemethod(_openbabel.OBMol_Assign,None,OBMol)
...
OBMol.GetMainAxes = new_instancemethod(_openbabel.OBMol_GetMainAxes,None,OBMol)
OBMol.SetDihedralAngle = new_instancemethod(_openbabel.OBMol_SetDihedralAngle,None,OBMol)
OBMol.SetAngle = new_instancemethod(_openbabel.OBMol_SetAngle,None,OBMol)
OBMol.PartMolecule = new_instancemethod(_openbabel.OBMol_PartMolecule,None,OBMol)
OBMol.Mirror = new_instancemethod(_openbabel.OBMol_Mirror,None,OBMol)
OBMol.BondMolecule = new_instancemethod(_openbabel.OBMol_BondMolecule,None,OBMol)
OBMol.CleaveOff = new_instancemethod(_openbabel.OBMol_CleaveOff,None,OBMol)
OBMol.AppendMolecule = new_instancemethod(_openbabel.OBMol_AppendMolecule,None,OBMol)
...
OBMol.DeleteConformers = new_instancemethod(_openbabel.OBMol_DeleteConformers,None,OBMol)
...
def IdxSort(*args):
  return _openbabel.IdxSort(*args)
IdxSort = _openbabel.IdxSort
class OBAggregate(OBMol):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, *args): 
        _openbabel.OBAggregate_swiginit(self,_openbabel.new_OBAggregate(*args))
    __swig_destroy__ = _openbabel.delete_OBAggregate
OBAggregate.Assign = new_instancemethod(_openbabel.OBAggregate_Assign,None,OBAggregate)
OBAggregate.AppendMolecule = new_instancemethod(_openbabel.OBAggregate_AppendMolecule,None,OBAggregate)
OBAggregate.IsGoodVDW = new_instancemethod(_openbabel.OBAggregate_IsGoodVDW,None,OBAggregate)
OBAggregate.MinVDWDist = new_instancemethod(_openbabel.OBAggregate_MinVDWDist,None,OBAggregate)
OBAggregate.FindConnectedChildren = new_instancemethod(_openbabel.OBAggregate_FindConnectedChildren,None,OBAggregate)
OBAggregate.FindAllConnections = new_instancemethod(_openbabel.OBAggregate_FindAllConnections,None,OBAggregate)
OBAggregate.PrintConnections = new_instancemethod(_openbabel.OBAggregate_PrintConnections,None,OBAggregate)
OBAggregate.GetConnections = new_instancemethod(_openbabel.OBAggregate_GetConnections,None,OBAggregate)
OBAggregate.PrintTags = new_instancemethod(_openbabel.OBAggregate_PrintTags,None,OBAggregate)
OBAggregate.GetTags = new_instancemethod(_openbabel.OBAggregate_GetTags,None,OBAggregate)
OBAggregate.GetNrMolecules = new_instancemethod(_openbabel.OBAggregate_GetNrMolecules,None,OBAggregate)
OBAggregate.GetNrTags = new_instancemethod(_openbabel.OBAggregate_GetNrTags,None,OBAggregate)
OBAggregate.GetUseTag = new_instancemethod(_openbabel.OBAggregate_GetUseTag,None,OBAggregate)
OBAggregate.GetCenterPart = new_instancemethod(_openbabel.OBAggregate_GetCenterPart,None,OBAggregate)
OBAggregate.EnableTags = new_instancemethod(_openbabel.OBAggregate_EnableTags,None,OBAggregate)
OBAggregate.DisableTags = new_instancemethod(_openbabel.OBAggregate_DisableTags,None,OBAggregate)
OBAggregate.CreateTag = new_instancemethod(_openbabel.OBAggregate_CreateTag,None,OBAggregate)
OBAggregate.AddToTag = new_instancemethod(_openbabel.OBAggregate_AddToTag,None,OBAggregate)
OBAggregate.RotatePart = new_instancemethod(_openbabel.OBAggregate_RotatePart,None,OBAggregate)
OBAggregate.TranslatePart = new_instancemethod(_openbabel.OBAggregate_TranslatePart,None,OBAggregate)
OBAggregate.AlignPart = new_instancemethod(_openbabel.OBAggregate_AlignPart,None,OBAggregate)
OBAggregate.MirrorPart = new_instancemethod(_openbabel.OBAggregate_MirrorPart,None,OBAggregate)
OBAggregate.MovePartsCloser = new_instancemethod(_openbabel.OBAggregate_MovePartsCloser,None,OBAggregate)
OBAggregate_swigregister = _openbabel.OBAggregate_swigregister
OBAggregate_swigregister(OBAggregate)
NoId = cvar.NoId
...
OBForceField.ScreenByRMSD = new_instancemethod(_openbabel.OBForceField_ScreenByRMSD,None,OBForceField)
...
class OBPointGroup(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self): 
        _openbabel.OBPointGroup_swiginit(self,_openbabel.new_OBPointGroup())
    __swig_destroy__ = _openbabel.delete_OBPointGroup
    C1 = _openbabel.OBPointGroup_C1
    Cs = _openbabel.OBPointGroup_Cs
    Ci = _openbabel.OBPointGroup_Ci
    C2 = _openbabel.OBPointGroup_C2
    C3 = _openbabel.OBPointGroup_C3
    C4 = _openbabel.OBPointGroup_C4
    C5 = _openbabel.OBPointGroup_C5
    C6 = _openbabel.OBPointGroup_C6
    C7 = _openbabel.OBPointGroup_C7
    C8 = _openbabel.OBPointGroup_C8
    D2 = _openbabel.OBPointGroup_D2
    D3 = _openbabel.OBPointGroup_D3
    D4 = _openbabel.OBPointGroup_D4
    D5 = _openbabel.OBPointGroup_D5
    D6 = _openbabel.OBPointGroup_D6
    D7 = _openbabel.OBPointGroup_D7
    D8 = _openbabel.OBPointGroup_D8
    C2v = _openbabel.OBPointGroup_C2v
    C3v = _openbabel.OBPointGroup_C3v
    C4v = _openbabel.OBPointGroup_C4v
    C5v = _openbabel.OBPointGroup_C5v
    C6v = _openbabel.OBPointGroup_C6v
    C7v = _openbabel.OBPointGroup_C7v
    C8v = _openbabel.OBPointGroup_C8v
    C2h = _openbabel.OBPointGroup_C2h
    C3h = _openbabel.OBPointGroup_C3h
    C4h = _openbabel.OBPointGroup_C4h
    C5h = _openbabel.OBPointGroup_C5h
    C6h = _openbabel.OBPointGroup_C6h
    C7h = _openbabel.OBPointGroup_C7h
    C8h = _openbabel.OBPointGroup_C8h
    D2d = _openbabel.OBPointGroup_D2d
    D3d = _openbabel.OBPointGroup_D3d
    D4d = _openbabel.OBPointGroup_D4d
    D5d = _openbabel.OBPointGroup_D5d
    D6d = _openbabel.OBPointGroup_D6d
    D7d = _openbabel.OBPointGroup_D7d
    D8d = _openbabel.OBPointGroup_D8d
    D2h = _openbabel.OBPointGroup_D2h
    D3h = _openbabel.OBPointGroup_D3h
    D4h = _openbabel.OBPointGroup_D4h
    D5h = _openbabel.OBPointGroup_D5h
    D6h = _openbabel.OBPointGroup_D6h
    D7h = _openbabel.OBPointGroup_D7h
    D8h = _openbabel.OBPointGroup_D8h
    S4 = _openbabel.OBPointGroup_S4
    S6 = _openbabel.OBPointGroup_S6
    S8 = _openbabel.OBPointGroup_S8
    T = _openbabel.OBPointGroup_T
    Th = _openbabel.OBPointGroup_Th
    Td = _openbabel.OBPointGroup_Td
    O = _openbabel.OBPointGroup_O
    Oh = _openbabel.OBPointGroup_Oh
    Cinfv = _openbabel.OBPointGroup_Cinfv
    Dinfh = _openbabel.OBPointGroup_Dinfh
    I = _openbabel.OBPointGroup_I
    Ih = _openbabel.OBPointGroup_Ih
    K = _openbabel.OBPointGroup_K
    Kh = _openbabel.OBPointGroup_Kh
    Unknown = _openbabel.OBPointGroup_Unknown
OBPointGroup.Setup = new_instancemethod(_openbabel.OBPointGroup_Setup,None,OBPointGroup)
OBPointGroup.IdentifyPointGroup = new_instancemethod(_openbabel.OBPointGroup_IdentifyPointGroup,None,OBPointGroup)
OBPointGroup.IdentifyPointGroupSymbol = new_instancemethod(_openbabel.OBPointGroup_IdentifyPointGroupSymbol,None,OBPointGroup)
OBPointGroup.Symmetrize = new_instancemethod(_openbabel.OBPointGroup_Symmetrize,None,OBPointGroup)
OBPointGroup_swigregister = _openbabel.OBPointGroup_swigregister
OBPointGroup_swigregister(OBPointGroup)
